            ...
            <div className="grid md:grid-cols-12 grid-cols-1 items-center gap-6 relative">
                ...
                <div className="md:col-span-7">
                    <div className="lg:ms-8">
                        <h3 className="mb-6 md:text-3xl text-2xl md:leading-normal leading-normal font-semibold">KNOW YOUR RIDER</h3>

                        <p className="text-slate-400 max-w-xl mb-6">Hi I am NITIN SURYAVANSHI ! I am a vagabonding nomad bagpacker who started as a passionate solo traveler & eventually turned my hobby into my profession as travel organiser. I love treasure hunting places and traveling the untraveled path, bagpacking, creating & capturing memories, and everything in between (and yes I am a good friend and a responsible man in real life too!).</p>
