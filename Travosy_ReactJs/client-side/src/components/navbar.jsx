        ...
        <nav id="topnav" className={`${navclass} ${scrolling ? 'nav-sticky' : ''}`}>
            <div className="container relative">
                ...
                {/* <li className={`has-submenu parent-menu-item ${['/grid','/grid-left-sidebar','/grid-right-sidebar','/grid-item'].includes(manu) ? 'active' : ''}`}>
                    ...
                    <li className={`${manu === '/grid' ? 'active' : '' }`}><Link to="/leh-ladakh" className="sub-menu-item">Special offers</Link></li>


        <li className={`has-submenu parent-menu-item ${['/','/index-two','/index-three','/index-four','/index-five','/index-item'].includes(manu) ? 'active' : '' }`}>
                            <Link to="/adventure" onClick={()=>setSubManu(setManu === '/index-item' ? '' : '/index-item')}>Adventure</Link><span className="menu-arrow"></span>
                            <ul className={`submenu ${['/list','/grid','/list','/grid','/list','/index-item'].includes(subManu) ? 'open' : '' }`}>
                                <li className={`${manu === '/list' ? 'active' : '' }`}><Link to="/list" className="sub-menu-item">Rishikesh</Link></li>
                                <li className={`${manu === '/grid' ? 'active' : '' }`}><Link to="/grid" className="sub-menu-item">Trekking</Link></li>
                                <li className={`${manu === '/list' ? 'active' : '' }`}><Link to="/list" className="sub-menu-item">Leh Ladakh Package</Link></li>
                                <li className={`${manu === '/grid' ? 'active' : '' }`}><Link to="/grid" className="sub-menu-item">Spiti Valley</Link></li>
                                <li className={`${manu === '/list' ? 'active' : '' }`}><Link to="/list" className="sub-menu-item">Winter Spiti Valley</Link></li>
                            </ul>
                        </li>

                        <li className={`${manu === '/grid' ? 'active' : '' }`}><Link to="/domestic" className="sub-menu-item">Domestic</Link></li>

          
                        <li className={`has-submenu parent-menu-item ${['/','/index-two','/index-three','/index-four','/index-five','/index-item'].includes(manu) ? 'active' : '' }`}>
                            <Link to="/international" onClick={()=>setSubManu(setManu === '/index-item' ? '' : '/index-item')}>International</Link><span className="menu-arrow"></span>
                            <ul className={`submenu ${['/list','/grid','/list','/grid','/list','/index-item'].includes(subManu) ? 'open' : '' }`}>
                                <li className={`${manu === '/list' ? 'active' : '' }`}><Link to="/list" className="sub-menu-item">Dubai</Link></li>
                                <li className={`${manu === '/grid' ? 'active' : '' }`}><Link to="/grid" className="sub-menu-item">Malaysia</Link></li>
                                <li className={`${manu === '/list' ? 'active' : '' }`}><Link to="/list" className="sub-menu-item">Singapore</Link></li>
                                <li className={`${manu === '/grid' ? 'active' : '' }`}><Link to="/grid" className="sub-menu-item">Thailand</Link></li>
                            </ul>
                        </li>
