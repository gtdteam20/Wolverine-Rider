      ...
      <section className="relative table w-full items-center py-36 bg-[url('../../assets/images/bg/cta.jpg')] bg-top bg-no-repeat bg-cover">
          ...
          <div className="flex justify-center mt-4">
            <ul className="flex space-x-4">
              ...
              <li>
                <button
                  className="text-white bg-red-500 px-4 py-2 rounded-md hover:bg-red-600"
                  onClick={() => setFilterPlace("Malaysia")}
                >
                  Malaysia
                </button>
              </li>
              <li>
                <button
                  className="text-white bg-red-500 px-4 py-2 rounded-md hover:bg-red-600"
                  onClick={() => setFilterPlace("Singapore")}
                >
                  Singapore
                </button>
              </li>
              <li>
                <button
                  className="text-white bg-red-500 px-4 py-2 rounded-md hover:bg-red-600"
                  onClick={() => setFilterPlace("Thailand")}
                >
                  Thailand
                </button>
              </li>
        ...
        <div className="absolute text-center z-10 bottom-5 start-0 end-0 mx-3">
                <ul className="tracking-[0.5px] mb-0 inline-block">
                    ...
                    <li className="inline-block uppercase text-[13px] font-bold duration-500 ease-in-out text-white" aria-current="page">International</li>
                </ul>
            </div>
      </section>
