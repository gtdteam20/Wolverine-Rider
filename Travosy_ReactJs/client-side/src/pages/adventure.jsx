      ...
      <section className="relative table w-full items-center py-36 bg-[url('../../assets/images/bg/cta.jpg')] bg-top bg-no-repeat bg-cover">
        ...
        <div className="container relative">
          <div className="grid grid-cols-1 pb-8 text-center mt-10">
            <h3 className="text-4xl leading-normal tracking-wider font-semibold text-white">Adventure Packages</h3>
          </div>
        </div>
      </section>
      ...
      <section className="relative md:py-24 py-16">
        <div className="container relative">
          {loading ? (
            ...
            <div className="text-center">No Adventure tours available.</div>
          )}
        </div>
      </section>
